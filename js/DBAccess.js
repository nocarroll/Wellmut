...
var DATA = [[1, 1, '22-03-2015 10:25:00', '{"name":"sleep","type":"number","value":"6.4"}', [53.336338, -6.266140]], //Camden Street
            [1, 2, '23-03-2015 10:25:00', '{"name":"sleep","type":"number","value":"8.1"}', [53.343897, -6.263399]], //Dame Lane
            [1, 3, '24-03-2015 10:25:00', '{"name":"sleep","type":"number","value":"6"}', [53.345653, -6.257400]], //Doyle's Pub
            [1, 4, '25-03-2015 10:25:00', '{"name":"sleep","type":"number","value":"6"}', [53.348045, -6.270343]], //Hacienda Bar
            
            [1, 5, '22-03-2015 10:25:00', '{"name":"sports","type":"number","value":"1.2"}', [53.336338, -6.266140]], //Camden Street
            [1, 6, '23-03-2015 10:25:00', '{"name":"sports","type":"number","value":"0.2"}', [53.343897, -6.263399]], //Dame Lane
            [1, 7, '24-03-2015 10:25:00', '{"name":"sports","type":"number","value":"1.3"}', [53.345653, -6.257400]], //Doyle's Pub
            [1, 8, '25-03-2015 10:25:00', '{"name":"sports","type":"number","value":"1.8"}', [53.348045, -6.270343]], //Hacienda Bar
            
            [1, 9, '22-03-2015 10:25:00', '{"name":"reading","type":"number","value":"2.5"}', [53.336338, -6.266140]], //Camden Street
            [1, 10, '23-03-2015 10:25:00', '{"name":"reading","type":"number","value":"2.1"}', [53.343897, -6.263399]], //Dame Lane
            [1, 11, '24-03-2015 10:25:00', '{"name":"reading","type":"number","value":"1.0"}', [53.345653, -6.257400]], //Doyle's Pub
            [1, 12, '25-03-2015 10:25:00', '{"name":"reading","type":"number","value":"0.4"}', [53.348045, -6.270343]], //Hacienda Bar
			...
			[1, 27, '01-04-2015 10:25:00', '{"name":"mood","type":"number","value":"5"}', [49.932760, 8.313461]], //Alessa's House
			[1, 28, '02-04-2015 10:25:00', '{"name":"mood","type":"number","value":"5"}', [53.343197, -6.271439]], //Christ Church
			[1, 29, '03-04-2015 10:25:00', '{"name":"mood","type":"number","value":"4"}', [53.338379, -6.257692]], //Stephen's Green
			[1, 30, '04-04-2015 10:25:00', '{"name":"mood","type":"number","value":"4"}', [53.343699, -6.256464]], //TCD Campus
			[1, 31, '05-04-2015 10:25:00', '{"name":"mood","type":"number","value":"4"}', [53.370798, -6.274575]] // Glasnevin
			
			
            
			];
			
var DATA_ID_COUNTER = 80;
...
function dbGetSecondaryDiagramsOfUser(userID, planID){
	...
	var thirdDiagramSpec = JSON.parse(	'{"diagram":{'+
										'"type":"bar",'+
										'"datasets":[],'+
										'"highcharts":{'+
										    	'"chart":{"type":"bar"},'+
										    	'"title":{"text": "Conversations"},'+
										    	'"subtitle":{"text":"Last year"},'+
										    	'"xAxis":{"categories":["Mar \'15","Feb \'15","Jan \'15","Dec \'14","Nov \'14","Oct \'14","Sep \'14","Aug \'14","Jul \'14","Jun \'14","May \'14","Apr \'14"]},'+
										    	'"yAxis":[{"title":"none","opposite": true}],'+
										    	'"plotOptions":{'+
										    		'"column":{'+
										    			'"grouping":false,'+
										    			'"shadow":false,'+
										    	...
										    	'"series":[{'+
										    		'"name":"Family",'+
										    		'"color":"#fdbca3",'+
										    		'"data":[150,73,20,143,135,93,102,45,32,87,150,145],'+
										    		'"pointPadding":-0.7 ,'+
										    		'"pointPlacement":0.6'+
										    	'}, {'+
										    		'"name":"Family in person",'+
										    		'"color":"#fd885c",'+
										    		'"data":[135,43,7,93,135,87,100,15,12,17,143,136],'+
										    		'"pointPadding":-0.3,'+
										    		'"pointPlacement":0.5'+
										    	'}, {'+
										    		'"name":"Friends",'+
										    		'"color":"#70dbc8",'+
										    		'"data":[236,287,200,17,135,143,117,193,193,235,115,112],'+
										    		'"pointPadding":-0.7,'+
										    		'"pointPlacement":0.1'+
										    	'}, {'+
										    		'"name":"Friends in person",'+
										    		'"color":"#1db095",'+
										    		'"data":[206,167,90,2,35,43,67,133,113,35,75,92],'+
										    		'"pointPadding":-0.3,'+
										    		'"pointPlacement":0'+
										    	'}, {'+
										    		'"name":"Others",'+
										    		'"color":"#f3d8f3",'+
										    		'"data":[35,72,50,23,10,43,50,45,63,35,22,87],'+
										    		'"pointPadding":-0.6,'+
										    		'"pointPlacement":0.6'+
										    	'}, {'+
										    		'"name":"Others in person",'+
										    		'"color":"#e8a9e7",'+
										    		'"data":[30,68,47,16,9,36,47,35,53,45,12,79],'+
										    		'"pointPadding":-0.3,'+
										    		'"pointPlacement":0.5'+
										    	'}]'+
										    '}'+
